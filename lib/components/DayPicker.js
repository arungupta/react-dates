...
/***/ function(module, exports, __webpack_require__) {
	...
	var DayPicker = function (_React$Component) {
	  ...
	  function DayPicker(props) {
	    ...
	    _this.handleEndDateInputFocus = _this.handleEndDateInputFocus.bind(_this);
	    _this.handleStartDateInputFocus = _this.handleStartDateInputFocus.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(DayPicker, [{
	    ...
	    key: 'handleStartDateInputFocus',
	    value: function () {
	      function handleStartDateInputFocus() {
	        if (!this.state.start && !this.props.startDate) {
	          var startDatePlaceholder = this.props.startDatePlaceholder;

	          this.onStartDateInputChange(startDatePlaceholder);
	        }
	      }

	      return handleStartDateInputFocus;
	    }()
	  }, {
	    key: 'handleEndDateInputFocus',
	    value: function () {
	      function handleEndDateInputFocus() {
	        if (!this.state.end && !this.props.endDate) {
	          var endDatePlaceholder = this.props.endDatePlaceholder;

	          this.onEndDateInputChange(this.props.endDatePlaceholder);
	        }
	      }

	      return handleEndDateInputFocus;
	    }()
	  }, {
	      ...
	      function componentWillReceiveProps(nextProps) {
	        ...
	        if (!this.hasSetInitialVisibleMonth && !nextProps.hidden) {
	          ...
	          this.setState({
	            ...
	            _this2.updateStateAfterMonthTransition();
	            _this2.adjustDayPickerHeight();
	          });
	        }
	    ...
	    value: function () {
	      function handleSumbit(input, event) {
	        ...
	        startDate = (0, _moment2['default'])(start, "MM/DD/YYYY HH:mm:ss", true);
	        endDate = (0, _moment2['default'])(end, "MM/DD/YYYY HH:mm:ss", true);

	        if (input === "start") {
	          this.props.onSubmit("startDate", { startDate: startDate, endDate: endDate });

	          if (startDate.isValid()) {
	            this.endInputRef.focus();
	          }
	        } else if (input === "end") {
	          this.props.onSubmit("endDate", { startDate: startDate, endDate: endDate });
	      ...
	      function adjustDayPickerHeight() {
	        ...
	        [].concat(_toConsumableArray(transitionContainer.querySelectorAll('.CalendarMonth'))).forEach(function (el) {
	          if (el.getAttribute('data-visible') === 'true') {
	            heights.push(_this3.getMonthHeight(el));
	          }
	        });
	    ...
	    value: function () {
	      function render() {
	        ...
	        var translationValue = _state3.translationValue;
	        ...
	        var startDatePlaceholder = _props.startDatePlaceholder;
	        var endDatePlaceholder = _props.endDatePlaceholder;
	        ...
	        return _react2['default'].createElement('div', { className: dayPickerClassNames, style: dayPickerStyle }, _react2['default'].createElement(_OutsideClickHandler2['default'], { onOutsideClick: onOutsideClick }, this.renderNavigation(), _react2['default'].createElement('div', { className: 'DayPicker__week-headers' }, weekHeaders), _react2['default'].createElement('div', {
	          ...
	          monthFormat: monthFormat
	            ...
	            function onSubmit(e) {
	              return _this4.handleSumbit("start", e);
	            }
	          ...
	          onChange: function () {
	            function onChange(e) {
	              return _this4.onStartDateInputChange(e.target.value);
	            }
	          ...
	          maxLength: 20
	            ...
	            function onSubmit(e) {
	              return _this4.handleSumbit("end", e);
	            }
	          ...
	          onChange: function () {
	            function onChange(e) {
	              return _this4.onEndDateInputChange(e.target.value);
	            }
